...
local message = {
    ["matchConditions"] = {
        {
            ["regEx"] = "Uber: YourName - \"(?'ridetype'.+)\" arriving soon",
            ["type"] = "setGlobalVariable",   --> Echo this info back, use later <--
            ["parts"] = {
              {
                ["variableName"] = "YourNameLeaving",   --> Name of global variable <--
                ["regExGroupName"] = "ridetype",
                ["matchConditions"] = {
                  "home",
                  "work",
                  "other"
